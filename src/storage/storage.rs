...
//!   [`crate::storage::atomic_file`], which fsyncs the temporary **and** the directory the rename
//!   changes; until I14 it fsynced neither, and this list said so. What is still true is the part
