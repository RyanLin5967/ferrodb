...
Driver `scratchpad/F9-mutants.py`, transcript `scratchpad/F9-mutants.md`. Every named test was
...
and an interrupted run reports as a pass. Durable, resumable results in `scratchpad/F9-suite.txt`;
runner `scratchpad/F9-run-suite.sh`.
