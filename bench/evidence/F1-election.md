...
Driver: `bench/evidence/mutants.py` (record in `bench/evidence/mutants.json`, transcripts in
...
(`bench/evidence/lib-suite.txt`, exit 0) rather than watched, because a full `cargo test` in this
