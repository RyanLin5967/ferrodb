...
`bench/evidence/F7-signing.md` — this file — was committed **empty** as `ae76c6f`, and the content above
...
— `PROGRESS.md`, `bench/evidence/F7-signing.md`, and `src/consensus/{node,signing,tests_signing,
